            ...
            if (Combination::isFeatureActive() && $item['id_product_attribute']){
                ...
                if (!empty($combinations)) {
                    ...
                    foreach ($combinations as $k => $combination) {
                        ...
                        $group_name =  str_replace(Configuration::get('PS_ATTRIBUTE_ANCHOR_SEPARATOR'), '_', Tools::str2url(str_replace(array(',', '.'), '-', $combination['group_name'])));
                        $attribute_name =  str_replace(Configuration::get('PS_ATTRIBUTE_ANCHOR_SEPARATOR'), '_', Tools::str2url(str_replace(array(',', '.'), '-', $combination['attribute_name'])));
