    ...
    public function installDb()
    {
        $dbExecuted =
            Db::getInstance()->execute("
                ...
                PRIMARY KEY (`id_slide`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
            ")
            && Db::getInstance()->execute("
            ...
            && Db::getInstance()->execute("
                ...
                PRIMARY KEY (`id_layer`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
            ")
            && Db::getInstance()->execute("
